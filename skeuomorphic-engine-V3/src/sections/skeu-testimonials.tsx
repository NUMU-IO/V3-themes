...
/**
 * Warsha testimonials — magazine pull-quotes instead of review cards.
...
export default function SkeuTestimonials({ instance, sectionId }: SectionRenderProps) {
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="max-w-4xl mx-auto space-y-14 md:space-y-20">
          {reviews.map((review, i) => (
            ...
            >
              <RuleDraw on={on} delay={0.15} className={`skeu-foil-rule mb-5 ${i % 2 === 1 ? "ms-auto" : ""} !w-16`}>
                <span aria-hidden="true" />
              </RuleDraw>
              <p className="skeu-pull-quote text-[hsl(var(--foreground))]">
