...
/**
 * skeu-cart — the cart template body.
 *
 * Warsha shipped only a header+footer stub `cart` template (no body section),
 * so the cart page rendered blank between the chrome. This is the missing body:
 * the grayscale-and-gold editorial cart, in Warsha's `vn-*` design language —
 ...
 */
export default function WarshaCart({ instance, sectionId }: SectionRenderProps) {
