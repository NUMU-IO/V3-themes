...
/**
 * skeu-footer — faithful V3 port of V2 WarshaStoreFooter
 * (numu-egyptian-bazaar/src/components/store/manshet/WarshaStoreFooter.tsx),
...
export default function WarshaFooter({ instance, sectionId }: SectionRenderProps) {
  ...
  return (
    <footer className="vn-footer" data-skeu-section={sectionId}>
