...
/**
 * Warsha Scrolling Banner section.
 *
...
> = {
  green: {
    // Warsha signature: the editorial green drench band.
    bg: "var(--skeu-primary)",
    fg: "var(--vn-white)",
    border: "transparent",
  },
...
const WarshaMarquee = ({ instance }: SectionRenderProps) => {
