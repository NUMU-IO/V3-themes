...
const SkeuAnnouncementBar = ({ instance }: SectionRenderProps) => {
  ...
  return (
    <div className="skeu-announcement relative py-2.5 px-4 text-center text-sm font-medium">
      <div className="container mx-auto flex items-center justify-center gap-2">
        <span>{text}</span>
        {linkUrl && (
          <Link to={linkUrl} className="underline underline-offset-2 font-bold hover:opacity-80 transition-opacity">
            {linkText}
          </Link>
        )}
      </div>
...
export default SkeuAnnouncementBar;
