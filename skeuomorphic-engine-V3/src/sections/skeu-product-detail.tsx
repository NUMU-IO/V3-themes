...
/**
 * Warsha product-detail section.
 *
 * Faithful port of the V2 Warsha PDP look (gallery-left / info-right, the
 * `vn-*` utility classes + Warsha tokens) re-plumbed on the V3 SDK.
 *
 * V2 sources mirrored:
 ...
 *    availability map)
 *  - components/store/manshet/WarshaProductCard.tsx (related card markup +
...
export default function WarshaProductDetail({ instance, sectionId }: SectionRenderProps) {
          ...
          <div>
            ...
            <div className="flex items-center gap-3 mb-4">
              ...
              {/* The SDK's <AddToCartButton> owns the loading/disabled/error
                  ...
                  without re-implementing it. We only supply Warsha styling. */}
              <AddToCartButton
                product={product}
