/**
 * Tailwind config for the Boutique V3 theme bundle (Tailwind-in-bundle — see
 * bazar's config for the full rationale). Boutique's V2 sections are authored
 * in Tailwind utility classes (`py-14`, `grid grid-cols-...`, `bg-background`,
 * `text-primary-foreground`, arbitrary values like `bg-[hsl(var(--hero-bg))]`).
 ...
 * src/theme.css (ported from V2 boutique styles.css) defines, so `bg-background`
