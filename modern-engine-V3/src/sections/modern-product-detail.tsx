 ...
 *
 * Copied from the proven Vionne V3 PDP (gallery-left / info-right) and
 * re-identified for Modern. The `vn-*` utility classes + `--vn-*` tokens it
 * uses are defined in Modern's src/theme.css, re-mapped to Modern's clean teal
 * palette, so the page renders in Modern's identity.
 *
 ...
 */
export default function ModernProductDetail({ instance }: SectionRenderProps) {
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12">
          ...
          <div>
            <motion.div
              ...
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
              className="relative overflow-hidden rounded-2xl bg-[var(--vn-band)] aspect-[3/4] mb-3"
              ...
              <div className="flex gap-2 overflow-x-auto">
                {images.map((img, i) => (
                  <button
                    ...
                    className={
                      "w-20 h-24 shrink-0 overflow-hidden rounded-lg transition-all border-2 " +
                      (i === activeImage
          ...
          <div>
                        ...
                        <button
                          ...
                          className={
                            isColor
                              ...
                              : "min-w-[44px] h-10 px-3 text-sm font-medium rounded-lg transition-colors border " +
                                (active
            ...
            <div className="flex items-center gap-3 mb-4">
              ...
              {/* The SDK's <AddToCartButton> owns the loading/disabled/error
                  ...
                  without re-implementing it. We only supply Modern styling. */}
              <AddToCartButton
                product={product}
            ...
            >
              {related.items.map((p) => {
                ...
                return (
                  ...
                  >
                    <div className="relative aspect-[3/4] overflow-hidden rounded-2xl bg-[var(--vn-band)] mb-3">
                      {p.images?.[0]?.url ? (
                        <img
                          src={p.images[0].url}
                          alt={p.name}
