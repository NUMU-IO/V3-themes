...
/**
 * Mashkal product-detail section.
 *
 * Faithful port of the V2 Mashkal PDP look (gallery-left / info-right, the
 * `vn-*` utility classes + Mashkal tokens) re-plumbed on the V3 SDK.
 *
 * V2 sources mirrored:
 ...
 *    availability map)
 *  - components/store/manshet/MashkalProductCard.tsx (related card markup +
...
export default function MashkalProductDetail({ instance, sectionId }: SectionRenderProps) {
          ...
          <div>
            ...
            <div className="flex items-center gap-3 mb-4">
              ...
              {/* The SDK's <AddToCartButton> owns the loading/disabled/error
                  ...
                  without re-implementing it. We only supply Mashkal styling. */}
              <AddToCartButton
                product={product}
