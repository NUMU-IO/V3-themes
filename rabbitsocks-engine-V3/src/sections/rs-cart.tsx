...
/**
 * rs-cart — the cart template body.
 *
 * Mashkal shipped only a header+footer stub `cart` template (no body section),
 * so the cart page rendered blank between the chrome. This is the missing body:
 * the grayscale-and-gold editorial cart, in Mashkal's `vn-*` design language —
 ...
 */
export default function MashkalCart({ instance, sectionId }: SectionRenderProps) {
