...
/**
 * Mashkal order-confirmation section.
 *
 ...
 *
 * Uses Mashkal's design tokens (`var(--vn-ink)`, `var(--vn-band)`, etc.) and
 ...
 */
export default function MashkalOrderConfirmationSection({ instance, sectionId }: SectionRenderProps) {
