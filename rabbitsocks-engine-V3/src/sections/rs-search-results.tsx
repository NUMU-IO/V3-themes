...
/**
 * rs-search-results — body for the `search` template. Seeds its query from
 * the storefront /search route (`usePageData().data.query`) and renders a live,
 * underlined search field in the Mashkal voice plus an animated results grid.
 ...
 * backstop). Cards mirror the Mashkal product card.
 */
export default function MashkalSearchResults({ instance, sectionId }: SectionRenderProps) {
...
/** Compact Mashkal product card — mirrors vn-product-card classes. */
