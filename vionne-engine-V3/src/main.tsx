...
// (docs/Plans/theme-section-base/PHASE-4-THEMES-ADOPT-LIBRARY.md). theme.json
// hides lib-ugc-carousel and lib-before-after: Vionne keeps its own versions.
...
const v3Handle = {
  ...
  manifest: { id: "vionne-v3", name: "Vionne (V3)", version: "0.8.1" },
  mount,
};
