    ...
    <form className="mt-4" onSubmit={submit}>
      <div className="flex gap-2">
        <input
          ...
          className="min-w-0 flex-1 border border-border bg-transparent px-3 py-2 font-mono text-xs"
        />
        <button type="submit" disabled={busy || !code.trim()} className="lux-btn px-4 py-2 text-xs disabled:opacity-50">
