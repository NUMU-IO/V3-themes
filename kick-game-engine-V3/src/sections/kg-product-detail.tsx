    ...
    <div className="bg-background" data-testid="storefront-product-detail">
      <div className="container mx-auto px-4 py-6 md:py-10">
            ...
            {showGuarantees && (
              <div className="mt-8 pt-6 border-t border-[var(--vn-border)] flex flex-wrap items-center justify-between gap-4">
                {[
                  ...
                  { icon: ShieldCheck, label: localized(locale, "Authentic", "أصلي ١٠٠٪"), desc: localized(locale, "100% Genuine", "مضمون") },
                ].map((item) => (
        ...
        {showRelated && related.items.length > 0 && (
          ...
          >
            <h2 className="kg-heading text-xl text-[var(--vn-ink)] mb-6">{localized(locale, "You may also like", "ممكن يعجبك كمان")}</h2>
            <div
