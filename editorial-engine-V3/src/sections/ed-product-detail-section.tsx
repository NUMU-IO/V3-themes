...
/**
 * Manshet product-detail section.
 *
 * Faithful port of the V2 Manshet PDP look (gallery-left / info-right, the
 * `vn-*` utility classes + Manshet tokens) re-plumbed on the V3 SDK.
 *
 * V2 sources mirrored:
 ...
 *    availability map)
 *  - components/store/manshet/ManshetProductCard.tsx (related card markup +
...
export default function ManshetProductDetail({ instance, sectionId }: SectionRenderProps) {
          ...
          <div>
            ...
            <div className="flex items-center gap-3 mb-4">
              ...
              {/* The SDK's <AddToCartButton> owns the loading/disabled/error
                  ...
                  without re-implementing it. We only supply Manshet styling. */}
              <AddToCartButton
                product={product}
