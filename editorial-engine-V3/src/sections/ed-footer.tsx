...
/**
 * ed-footer — faithful V3 port of V2 ManshetStoreFooter
 * (numu-egyptian-bazaar/src/components/store/manshet/ManshetStoreFooter.tsx),
...
export default function ManshetFooter({ instance, sectionId }: SectionRenderProps) {
  ...
  return (
    <footer className="vn-footer" data-ed-section={sectionId}>
