...
/**
 * Manshet Scrolling Banner section.
 *
...
> = {
  green: {
    // Manshet signature: the editorial green drench band.
    bg: "var(--ed-primary)",
    fg: "var(--vn-white)",
    border: "transparent",
  },
...
const ManshetMarquee = ({ instance }: SectionRenderProps) => {
  ...
  const colorScheme = ((s.color_scheme as string) ?? "green") as keyof typeof COLOR_PRESETS | "custom";
  const colors =
    colorScheme === "custom"
      ? {
