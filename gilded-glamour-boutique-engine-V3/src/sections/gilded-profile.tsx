...
/**
 * Gilded account / profile section.
 *
 * Faithful port of the proven Vionne V3 profile page re-skinned to the Gilded
 * palette via the re-mapped `--vn-*` tokens in theme.css.
 *
...
export default function GildedProfile({ instance }: SectionRenderProps) {
      ...
      <div className="bg-background">
        <div className="container mx-auto px-4 py-20 text-center">
          ...
          <p className="vn-heading text-lg text-[var(--vn-ink)] mb-1">
            {localized(locale, "Login to view your account", "سجّل الدخول علشان تشوف حسابك")}
          </p>
              ...
              <div>
                ...
                {loadingAddresses ? (
                  ...
                  <div className="text-center py-16 border border-[var(--vn-border)] rounded-md">
                    ...
                    <p className="text-xs text-[var(--vn-muted)] mb-5">
                      {localized(locale, "Add an address to speed up checkout", "ضيف عنوان علشان تخلّص الدفع أسرع")}
                    </p>
                    <button
                      type="button"
                      onClick={openNewAddress}
