...
/**
 * Canva-style inline editor for theme text. Ported verbatim from the Empire
 * V3 _inline-editable.tsx (theme-agnostic — only the CSS class prefix and
 * the warn-tag differ: `emp-` → `gilded-`).
 *
...
export function InlineEditable({
  ...
  const commit = useCallback(
    (next: string) => {
      ...
      try {
        ...
        console.warn("[gilded] inline-edit postMessage failed", err);
      }
    },
  ...
  const baseClass = "gilded-inline-edit";
  const composed = [
    className,
