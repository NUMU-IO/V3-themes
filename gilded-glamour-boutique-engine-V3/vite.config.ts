...
/**
 * Gilded Glamour Boutique V3 build config.
 *
 * Tailwind-in-bundle (mirrors bazar/vionne): src/main.tsx imports src/theme.css,
 * whose `@tailwind` directives + the ported V2 gilded utility classes are
