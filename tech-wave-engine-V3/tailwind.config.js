/**
 * Tailwind config for the Tech Wave V3 theme bundle (Tailwind-in-bundle — see
 * vionne/bazar for the full rationale). Tech Wave's V2 sections are authored
 * in Tailwind utility classes (`py-14 md:py-20`, `grid grid-cols-[...]`,
 * `text-[hsl(var(--foreground))]`, arbitrary values) + custom `tw-*` classes.
 ...
 * src/theme.css (ported from V2 tech-wave styles.css) defines, so
