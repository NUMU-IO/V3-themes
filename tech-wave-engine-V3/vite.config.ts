...
/**
 * Tech Wave V3 build config.
 *
 * Tailwind-in-bundle (mirrors vionne/bazar): src/main.tsx imports src/theme.css,
 * whose `@tailwind` directives + the ported V2 tech-wave utility classes are
