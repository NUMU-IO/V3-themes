 ...
 * axes with sold-out treatment, quantity stepper, SDK <AddToCartButton>,
 * trust row, related grid) and re-skinned to Tech Wave via the `vn-*`
 * utility classes — which this theme's theme.css re-maps onto the dark/neon
 * palette. Data/actions are SDK-native (useProductOptional /
 * useVariantSelection / useRelatedProducts), so it never crashes and shows a
 * graceful empty state when there's no product in context.
 */
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12">
          ...
          <div>
            <motion.div
              ...
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
              className="relative overflow-hidden bg-[var(--vn-band)] aspect-[3/4] mb-3 rounded-xl tw-img-frame"
              ...
              <div className="flex gap-2 overflow-x-auto">
                {images.map((img, i) => (
                  <button
                    ...
                    className={
                      "w-20 h-24 shrink-0 overflow-hidden transition-all border-b-2 rounded-md " +
                      (i === activeImage
                        ? "border-[hsl(var(--primary))] opacity-100"
          ...
          <div>
            ...
            <div className="flex items-baseline gap-3 mb-5">
              <span className="text-2xl font-semibold tw-neon-text">
              ...
              <div className="flex items-center gap-2 mb-6 vn-label text-[10px]">
                <span
                  className={
                    ...
                    (inStock ? "bg-[hsl(var(--primary))]" : "bg-[var(--vn-sale)]")
                  }
                />
                            ...
                            isColor
                              ? "flex items-center gap-2 px-3 py-2 text-sm transition-colors border rounded-md " +
                                (active
                                  ...
                                  : "border-[var(--vn-border)] hover:border-[hsl(var(--primary))]") +
                              ...
                              : "min-w-[44px] h-10 px-3 text-sm font-medium transition-colors border rounded-md " +
                                (active
                                  ...
                                  : "border-[var(--vn-border)] text-[var(--vn-ink)] hover:border-[hsl(var(--primary))]") +
                                (soldOut ? " opacity-50 line-through" : "")
                          }
            ...
            >
              {related.items.map((p) => (
                <Link
                  ...
                  className="vn-product-card tw-card group block rounded-2xl overflow-hidden"
                  data-testid="storefront-product-card"
                >
                  <div className="relative aspect-[3/4] overflow-hidden bg-[var(--vn-band)]">
                    {p.images?.[0]?.url ? (
                      <img
                        src={p.images[0].url}
                        alt={p.name}
